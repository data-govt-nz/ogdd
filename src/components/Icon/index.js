...
const SVG = styled.svg`
  ...
  max-width: 100%;
  width: ${(props) => (props.sizes && props.sizes.width) ? props.sizes.width : (props.size || '1em')};
  height: ${(props) => (props.sizes && props.sizes.height) ? props.sizes.height : (props.size || '1em')};
`;
